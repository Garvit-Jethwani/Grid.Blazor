...
namespace GridBlazorClientSide.Server.Models.Test
{
    ...
    public class GetByIdTest
    {
        ...
        public void Setup()
        {
            ...
            _mockContext.Setup(c => c.Set<Employee>()).Returns(_mockDbSet.Object);
        ...
        public async Task GetByIdReturnsCorrectEmployeeForValidId()
        {
            ...
            _mockDbSet.Setup(m => m.SingleOrDefaultAsync(It.IsAny<Func<Employee, bool>>(), It.IsAny<CancellationToken>()))
        ...
        {
            // Act & Assert
            Assert.ThrowsAsync<InvalidCastException>(async () => await _repository.GetById("invalid id"));
        }
